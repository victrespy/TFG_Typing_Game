 ...
 */
final class Version20260130201254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, user_id INT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, nickname VARCHAR(255) NOT NULL, rol JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, banned BOOLEAN NOT NULL, PRIMARY KEY (id))');
